...
const MentorshipConversation = ({ isEmbedded = false, mentorshipId = null }) => {
    ...
    const handleDeleteMessage = async (messageId) => {
        ...
        try {
            const res = await api.delete(`/api/mentorship/message/${id}/${messageId}`);
                    ...
                    <div className="relative group">
                        ...
                        <form onSubmit={handleSendMessage} className="relative bg-white p-3 flex gap-3 items-end shadow-2xl rounded-3xl transition-all duration-300">
                            ...
                            <button
                                ...
                                className="relative z-10 p-3.5 text-gray-600 hover:text-indigo-600 bg-gradient-to-br from-gray-50 to-gray-100 hover:from-indigo-50 hover:to-purple-50 rounded-2xl transition-all duration-300 flex-shrink-0 shadow-sm hover:shadow-md hover:scale-110 active:scale-95"
                                title="Attach file"
                            >
                                <Paperclip size={22} />
                            </button>
                            ...
                            {!newMessage.trim() && !selectedFile ? (
                                <button
                                    ...
                                    className="relative z-10 p-3.5 text-gray-600 hover:text-purple-600 bg-gradient-to-br from-gray-50 to-gray-100 hover:from-purple-50 hover:to-pink-50 rounded-2xl transition-all duration-300 flex-shrink-0 shadow-sm hover:shadow-md hover:scale-110 active:scale-95"
                                    title="Voice message"
                                >
                                    <Mic size={22} />
                                </button>
