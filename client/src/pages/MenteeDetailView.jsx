...
const MenteeDetailView = () => {
    ...
    const handleEndMentorship = async () => {
        if (!window.confirm('Are you sure you want to end this mentorship? This will remove the student from your list and disable chat access.')) return;
        try {
                    ...
                    <div className="bg-white rounded-2xl shadow-md border border-gray-200 overflow-hidden">
                        ...
                        <div className="bg-gradient-to-br from-indigo-500 to-purple-600 p-6 text-center">
                            <div className="relative inline-block mb-3">
                                ...
                                <div className="absolute -bottom-1 -right-1 px-2.5 py-0.5 bg-green-500 text-white text-xs font-bold rounded-full shadow-lg border-2 border-white">
                                    Active
                                </div>
                            </div>
                                ...
                                <div className="md:col-span-2 space-y-6">
                                    <div className="bg-white rounded-[24px] shadow-xl border border-gray-100 p-8">
                                        ...
                                        <form onSubmit={handleAddNote} className="mb-10">
                                            <textarea
                                                className="w-full p-5 border border-gray-200 rounded-2xl bg-gray-50/50 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none transition-all resize-none min-h-[140px] text-base text-gray-900 placeholder-gray-400 shadow-inner"
